...
class CommentsController extends Controller
{
    ...
    public function manageComment($id) {
        ...
        return view('frontEnd.comment.manageComment',['comments' => $comments, 'userAddress' => $userAddress, 'userInfo' => $userInfo]);
    }
    ...
    public function editComment($id) {
        ...
        return view('frontEnd.comment.editComment',['comment' => $comment, 'userAddress' => $userAddress, 'userInfo' => $userInfo]);
    }
