...
<div class="row">
    <div class="col-lg-12">
        ...
        <hr/>
        <div class="well">
            {!! Form::open(['url'=>'admin/sub-category-update','name'=>'editSubCategoryForm', 'method'=>'POST','class'=>'form-horizontal' ])!!}
            <div class="form-group">
                <div class="col-sm-10">
                    <input type="hidden" value="{{$subCategoryById->id}}" class="form-control" name="subCategoryId">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <button type="submit" class="btn btn-success btn-block" name="">Update Sub-Category Info</button>
                </div>
            </div>
...
<script>
    document.forms['editSubCategoryForm'].elements['categoryId'].value = {{$subCategoryById->category_id}};
