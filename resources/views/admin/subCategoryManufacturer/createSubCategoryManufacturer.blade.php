...
<div class="row">
    <div class="col-lg-12">
        <h3 class="text-center">Add Sub-Category wise Manufacturer</h3>
        <h4 class="text-center text-success">{{Session::get('message')}}</h4>

        <hr/>
        <div class="well">
            {!! Form::open(['url'=>'admin/subcategorymanufacturer-save', 'method'=>'POST','class'=>'form-horizontal' ])!!}
